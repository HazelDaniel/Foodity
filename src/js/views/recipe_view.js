...
class RecipeView extends View {
	...
	_startDOMString = `<div class="recipe">`;
	_endDOMString = `</div>`;
  ...
  get _generateMarkup() {
    ...
    <figure class="recipe__fig">
      ...
      .map((ing) => {
        ing.quantity = ing.quantity === null || ing.quantity === "" || ing.quantity === 0 ? "" : ing.quantity;
        // console.log(ing.quantity);
        const ingQuantity = evalQuantity(ing.quantity);
					return `
              <li class="recipe__ingredient">
              <svg class="recipe__icon">
                <use href="../../src/img/icons.svg#icon-check"></use>
              </svg>
              <div class="recipe__quantity">${ingQuantity}</div>
